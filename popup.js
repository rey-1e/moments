...
// All themes are now offline and unlocked by default
const THEMES = [
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderThemes(activeThemeId) {
    ...
    THEMES.forEach(t => {
      ...
      slice.style.backgroundColor = t.lived;

      const dot = document.createElement('div');
      dot.className = 'theme-dot';
      dot.style.backgroundColor = t.current;
      ...
      btn.addEventListener('click', () => {
        ...
        chrome.storage.local.set({ theme: t.id, cachedThemeData: t }, () => {
